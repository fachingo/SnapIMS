...
def test_schema_13_contains_durable_item_lease(tmp_path: Path, data_paths) -> None:
...
def test_patch_does_not_regress_version() -> None:
    import snapims

    assert snapims.__version__ in {"0.10.0", "0.10.1"}
