...
from snapims.import_v0130 import normalize_location
...
def _updates_for(action: str, item: dict[str, Any], value: Any) -> dict[str, Any]:
    ...
    if action == "set_location":
        ...
        return {"location": location, "shelf": location or ""}
