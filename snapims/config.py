...
class DataPaths:
    ...
    def from_root(cls, root: str | Path | None = None) -> DataPaths:
        ...
        return cls(
            ...
            import_cache=base / "import-cache",
...
class ShopifyConfig:
    ...
    def problems(self, *, require_location: bool = True) -> list[str]:
        ...
        if not self.draft_only:
            problems.append("SnapIMS requires draft-first Shopify safety mode")
        return problems
